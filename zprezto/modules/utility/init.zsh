...
alias l='ls -1a'         # Exa: Lists in one column, hidden files.
alias ll='ls -l'         # Exa already list human readable sizes
alias la='ll -a'         # Exa: Lists human readable sizes, hidden files.
